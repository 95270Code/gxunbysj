...
<div region="north" split="true" border="false" style="overflow: hidden; height: 40px;
   ...
   <c:if test="${sessionScope.user!=null}" var="result" scope="session">     
        <span style="float:right; padding-right:20px; position:relative; top:10px;" class="head">欢迎 ${sessionScope.user.s_name } 
	        <a href="#" id="openPersonMsg">个人信息</a>
...
<div id="mainPanle" region="center" style="background: #eee; overflow-y:hidden">
      <div id="tabs" class="easyui-tabs"  fit="true" border="false" >
	       <div title="主页" style="padding:20px; color:red; " >
	          <h1 style="font-size:24px; text-align: center">公告</h1>
	          <div style="margin: auto;" id="divgg"><table id="box"></table></div>
	          <div id="dd"></div>
	       </div>
      </div>
...
<!--修改密码窗口-->
<!--个人信息窗口-->
<div id="personMsg" class="easyui-window" title="个人信息" collapsible="false" minimizable="false"
        maximizable="false" icon="icon-save"  style="width: 300px; height:180px;  padding: 5px;
        background: #fafafa;">
      <div class="easyui-layout" fit="true">
    <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
    <form id="fm_msg" method="post">
      <table cellpadding=3>        
        <tr>
              <td>学号：</td>
              <td><input id="s_id" name="s_id" type="text" class="txt01" /></td>
              <td>姓名：</td>
              <td><input id="xm_msg" type="text" class="txt01" /></td>
        </tr>

        <tr>
              <td>出生年月：</td>
              <td><input name="csny_msg" type= "text" class= "easyui-datebox"  required ="required" editable="false" style="height:20px; width:145px;" /></td>
              <td>性别：</td>
              <td><select class="easyui-combobox" name="xb_msg" required="true" editable="false" style="width:145px;height:20px;">   
        ...
        <tr>
              <td>职位：</td>
              <td><input id="qx_msg" type="text" class="txt01" /></td>
              <td>民族：</td>
              <td><input id="mz_msg" type="text" class="txt01" /></td>
        </tr>
        <tr>
              <td>学院：</td>
              <td><input id="qx_msg" type="text" class="txt01" /></td>
        ...
        <tr>
              <td>年级：</td>
              <td><input id="nj_msg" type="text" class="txt01" /></td>
              <td>班别：</td>
              <td><input id="bj_msg" type="text" class="txt01" /></td>
        </tr>
      </table>
    </form>
    </div>
    <div region="south" border="false" style="text-align: right; height: 30px; line-height: 30px;"> <a id="btnEp" class="easyui-linkbutton" onclick="editPassword()" icon="icon-ok" href="javascript:void(0)" > 确定</a> <a id="closePersonMsg" class="easyui-linkbutton" icon="icon-cancel" href="javascript:void(0)">取消</a> </div>
  </div>
    </div>
<!--个人信息窗口-->
        ...
        "menus":[
			      ...
			      "menus":[
			    	<c:if test="${user.qx>=3}" var="result" scope="session">
			    	  {"menuid":"12","menuname":"用户管理","icon":"icon-role","url":"${path}/user/showUserList.do"},
			    	  {"menuid":"15","menuname":"发布公告","icon":"icon-set","url":"demo.html"},
					</c:if>  
					{"menuid":"13","menuname":"填写申请奖助学金","icon":"icon-class","url":"${path}/page/form/sqbxz.jsp"},
					{"menuid":"14","menuname":"申请表查询","icon":"icon-page","url":"${path}/page/form/sqbcx.jsp"},
