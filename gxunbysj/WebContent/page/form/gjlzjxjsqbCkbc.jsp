...
<body>
<h1>广西民族大学国家励志奖学金申请表(未提交)</h1>
<form id="form1" class="easyui-form">
<table width="1000" border="1">
  <tr>
	    <td width="95" rowspan="7">个人情况</td>
	    <td width="106" height="50"><label for="name">姓名</label></td>
	    <td width="136"><input class="easyui-textbox" type="text" name="xm" data-options="required:true"   style="height:100%; " /></td>
	    <td width="46">性别</td>
	    <td width="110">
	  ...
	  <tr>
	    <td height="48">民族</td>
	    <td><input class="easyui-textbox" type="text" name="mz" data-options="required:true"   style="height:100%; " /></td>
	    <td>政治面貌</td>
	    <td><input class="easyui-textbox" type="text" name="zzmm" data-options="required:true"   style=" width:110px;height:100%; " /></td>
	    <td>学号</td>
	    <td><input class="easyui-textbox" type="text" name="xh" data-options="required:true"   style=" width:240px;height:50px; " /></td>
  </tr>
	  <tr>
	    <td height="35">身份证号码</td>
	    <td colspan="3"><input class="easyui-textbox" type="text" name="sfzhm" data-options="required:true"   style=" width:335px;height:50px; " /></td>
	    <td>联系电话</td>
	    <td><input class="easyui-textbox" type="text" name="lxdh" data-options="required:true"   style=" width:240px;height:50px; " /></td>
  </tr>
	  <tr>
	    <td rowspan="2">发奖学金银行账号</td>
	    <td height="60">本人银行卡号</td>
	    <td colspan="4"><input class="easyui-textbox" type="text" name="yhkh" data-options="required:true"   style=" width:510px;height:57px; " /></td>
  </tr>
	  <tr>
	    <td height="57">开户行名称</td>
	    <td colspan="4"><input class="easyui-textbox" type="text" name="khhmc" data-options="required:true"   style=" width:510px;height:57px; " /></td>
  </tr>
	  <tr>
	    <td height="43">学院</td>
	  ...
	  <tr>
	    ...
	    <td colspan="6"><input class="easyui-textbox" type="text" name="chhzjl" data-options="multiline:true"   style=" width:100%;height:100%; " /></td>
  </tr>
</table>
<table width="1000" border="1">
  <tr>
    ...
    <td colspan="3"><select id="cc" class="easyui-combobox" name="jthk" required="true"   editable="false" style="width:440px;height:20px;">   
				    <option value="c">城镇</option>   
				    <option value="n">农村</option>   
				</select></td>
    <td width="154">家庭人口总数</td>
    <td width="120"><input class="easyui-numberbox" type="text" name="jtrkzs" data-options="required:true"   style=" width:120px;height:20px; " /></td>
  </tr>
  <tr>
    <td>家庭月总收入</td>
    <td width="136"><input class="easyui-numberbox" type="text" name="jtysr" data-options="required:true,precision:2"   style=" width:147px;height:20px; " /></td>
    <td width="136">人均月收入</td>
    <td width="136"><input class="easyui-numberbox" type="text" name="rjysr" data-options="required:true,precision:2"   style=" width:147px;height:20px; " /></td>
    <td>收入来源</td>
...
<table width="1000" height="211" border="1">
  <tr>
    ...
    <td width="137"><input class="easyui-numberbox" type="text" name="kcs" data-options="required:true"   style=" width:145px;height:47px; " /></td>
    <td width="86">其中平均成绩</td>
    <td width="116"><input class="easyui-numberbox" type="text" name="pjf" data-options="required:true,precision:2"   style=" width:116px;height:47px; " /></td>
    <td width="108">最低成绩</td>
    <td width="109"><input class="easyui-numberbox" type="text" name="zdcj" data-options="required:true,precision:2"   style=" width:109px;height:47px; " /></td>
    <td width="120">&nbsp;</td>
  </tr>
  <tr>
...
<table width="1000" border="1">
  <tr>
    ...
    <td><input class="easyui-textbox" type="text" name="sqly" data-options="multiline:true"   style=" width:907px;height:76px; " /></td>
  </tr>
  <c:choose>
  	<c:when test="${user.qx==2||user.qx==4}">
		<tr>
...
<a class="easyui-linkbutton" iconCls="icon-tip" onclick="saveForm('N')">保存</a>
</form>
</body>
<script>
var sqbbh = "";
...
sqbbh = '${sqbbh}';
sqblx = '${sqblx}';
function submitOk(sfqrtj){
	$("#csny").attr("name","csnyString");
	if(sqbbh==""){
...
function saveForm(sfqrtj){
	var formData= $("#form1").serialize();
	var url = '${path}/jzxj/submitSave.do?sqbbh='+sqbbh+'&sfqrtj='+sfqrtj;
	alert(formData);
	$.ajax({
		url:url,
		type:'post',
